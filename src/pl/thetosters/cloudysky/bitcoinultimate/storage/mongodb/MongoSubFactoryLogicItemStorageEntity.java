/*
 * MongoSubFactoryLogicItemStorageEntity.java, version: 1.0.0
 * Date: 02-06-2013 19:22:13
 ...
 * 
 */
public class MongoSubFactoryLogicItemStorageEntity extends
                AbstractMongoSubFactory implements MongoObjectSerializer {

    private final static String COLL_NAME = "btc_logicStorage_entity";
    ...
    private LogicItemStorageEntity unpackFromDB(DBObject rs) {
        LogicItemStorageEntity record = new LogicItemStorageEntity();
        record.setId((String) rs.get("id"));
        record.setValues((Map<String, Object>) rs.get("values"));
        return record;
    }
    ...
    public List<LogicEntity> requestEntities(String key, Object value) {
        ...
        while (cur.hasNext() == true) {
            ...
            LogicItemStorageEntity record = unpackFromDB(rs);
            result.add(record);
        }
        cur.close();
        return result;
    ...
    public LogicEntity requestEntity(String key, Object value) {
        ...
        LogicItemStorageEntity record = null;
        if (rs != null) {
    ...
    public void setRepository(StorageLink repository) {
        ...
        this.repository.setSerializerFor(LogicItemStorageEntity.class, this);
    }
    ...
    public void remove(Object o) {
        ...
        BasicDBObject query = new BasicDBObject();
        query.put("id", ((LogicItemStorageEntity) o).getId());
        DBCursor cur = coll.find(query);
        while (cur.hasNext() == true) {
    ...
    private void doStore(Object o, boolean overwrite) {
        ...
        LogicItemStorageEntity ent = (LogicItemStorageEntity) o;
        doc.put("id", ent.getId());
        doc.put("values", ent.getValues());
